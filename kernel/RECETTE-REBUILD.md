...
- `patches-harrison/`  : 6 patches SP12 (SAM, panel eDP NE120DRM, ASoC speaker, qcom-scm,
  DTS `x1p42100-microsoft-sp12`, makefile) + `registry-next20260626.c`
...
2. `cd linux-next && git apply ../patches-harrison/000*.patch`
